...

{
  ...
  rows:: {
    ...
    collect: row.new('Collect').addPanels([panels.collect.success, panels.collect.err, panels.collect.timing]),
    deploy: row.new('Deploy').addPanels([panels.deploy.success, panels.deploy.err, panels.deploy.timing]),
