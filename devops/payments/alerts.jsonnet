...
local bffMobileAlerts = [
  {
    ...
    alerts: [
      ...
      },
      {
        ...
        counter: { name: 'gql_request_error', filters: target.combineFilters(bffMobileServiceFilter, target.equalsFilter('gql_operation_name', 'GetTripOrder')) },
        threshold: 1/60,
        message: msg,
      },
    ],
