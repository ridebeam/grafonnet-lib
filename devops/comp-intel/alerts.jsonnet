    ...
    alerts: [
      {
        ...
        threshold: 1200,
        evaluateFor: '60m',
        message: 'Comp-intel took too long, @dev-market-insights',
      },
    ],
  },
  {
    ...
    alerts: [
      {
        ...
        evaluateEvery: '1m',
        evaluateFor: '30m',
        message: 'Some Report Scraped NONE SCOOTERS : Only Beam, @dev-market-insights',
      },
    ],
  },
  {
    ...
    alerts: [
      {
        ...
        evaluateEvery: '1m',
        evaluateFor: '60m',
        message: 'Some Report Scraped NONE SCOOTERS : All except Beam, @dev-market-insights',
      },
    ],
  },
